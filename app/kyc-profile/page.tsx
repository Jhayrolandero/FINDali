...
export default function KYCProfilePage() {
  ...
  const handleKycSubmit = () => {
    ...
    alert(
      "KYC verification submitted successfully! You will receive an email confirmation shortly."
    );
  };
    ...
    switch (status) {
      ...
      default:
        return {
          ...
          description:
            "Complete KYC verification to unlock enhanced features and higher finder fees.",
        };
    }
  };
        ...
        <Card className={`mb-8 border p-6 ${kycInfo.color}`}>
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-start gap-4">
              <div
                className={`flex h-16 w-16 items-center justify-center rounded-full ${kycInfo.badge}`}
              >
                {kycInfo.icon}
              </div>
                ...
                {kycStatus === "verified" && userData.kycSubmittedDate && (
                  <div className="mt-2 flex items-center gap-2 text-sm">
                    ...
                    <span className="font-medium">
                      Verified on {userData.kycSubmittedDate}
                    </span>
                  </div>
                )}
              </div>
            ...
            <Card className="mb-8 border-border bg-card p-6">
              <div className="mb-6">
                ...
                <div className="mt-2 flex items-center justify-between text-sm">
                  ...
                  <span
                    className={
                      step >= 3 ? "font-medium" : "text-muted-foreground"
                    }
                  >
                    Review
                  </span>
          ...
          <Card className="border-green-500/20 bg-green-500/5 p-6">
            <div className="text-center">
              ...
              <p className="mb-6 text-muted-foreground">
                Your account is now verified. Enjoy enhanced features and higher
                finder fees!
              </p>
