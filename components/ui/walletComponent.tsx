...
const WalletComponent = () => {
  return (
    <Wallet>
      ...
      <WalletDropdown className="bg-slate-900 border border-cyan-500/30 rounded-xl shadow-2xl shadow-cyan-500/20">
        <Link href="/profile">
          <Identity
            className="px-4 pt-3 pb-2 hover:bg-gradient-to-r hover:from-slate-800 hover:to-slate-700 transition-all duration-200 border-b border-cyan-500/20 flex cursor-pointer"
